...
COMMONS
     ...
     &   TOTCARB(MAXSP),SUMCARB(MAXPLT),ICARB(MAXSP),AGCARB(MAXSP)
      ...
      REAL P,TBA,TBF,TCF,T,SUM,SUMSQ,ST,XBAR,S,SS,SE,UL,UU,CV,TCARB
      REAL SEU,SEP,SCF,SBF,SBA,SCARB,IDIST(8,5)
...
C----------
 ...
 9002 FORMAT(/2X,'SPECIES',T18,'BOARD FEET',T31,'CUBIC FEET',
     &  T52,'TREES',T61,'BASAL AREA',T74,'ABOVE GROUND CARBON',
     &  /,73('-'))
      ROWS=0
      DO 40 I=1,MAXSP
...
C
     ...
     &   BFVOL(I),AGCARB(I),IDIST(1,I),IDIST(2,I),IDIST(3,I),
