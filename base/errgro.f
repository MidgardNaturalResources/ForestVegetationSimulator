...
C                        ERROR NUMBER 43
 ...
 5310 FORMAT(/A11,'FVS43 WARNING: FIAVBC REQUESTED ',
     &  'BUT ECODIVISION CODE MISSING.  USING "0000" BY DEFAULT')
...
C                        ERROR NUMBER 54 NOTIFY USER OF INVALID ECO DIVISION CODE
 6400 CONTINUE
      WRITE(JOSTND,6410)  PREF
      WRITE(CMSG,  6411)

 6410 FORMAT(/A11,'FVS54 WARNING: ECO DIVISON NOT RECONIGIZED.')

 6411 FORMAT('FVS54 WARNING: ECO DIVISON NOT RECONIGIZED')
      IF (ICCODE .LT. 2) ICCODE=1
      GO TO 9000
