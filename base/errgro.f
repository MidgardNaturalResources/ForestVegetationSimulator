...
C                        ERROR NUMBER 41
 ...
 5110 FORMAT(/A11,'WARNING: IMPROPER FIELD INPUT IDENTIFIED. ',
...
C                        ERROR NUMBER 42
 ...
 5210 FORMAT(/A11,'WARNING: FIA NSVB REQUESTED BUT ECODIVISION CODE ',
     &  'MISSING.  USING "0000" BY DEFAULT')
      IF (ICCODE .LT. 2) ICCODE=1
...
C                        ERROR NUMBER 43
 ...
 5310 FORMAT(/A11,'WARNING: STATE CODE MISSING FROM INPUT.  ',
     & 'DEFAULT WOODLAND VOLUME EQUATIONS WILL BE USED FOR NSVB.')
      IF (ICCODE .LT. 2) ICCODE=1
