...
C
C  COEFFICIENTS FOR REDWOOD UPDATED JUNE 2021
C
...
C----------
C
      REAL OLYMPC(45,3),SIUSLW(45,3)
      REAL MTHOOD(45,3),WILLAM(45,3)
...
C   38 = ACKO     KOA                       ACACIA KOA
C   39 = MELE2    OHIA                      METROSIDEROS POLYMORPHA
C   40 = SAFR4    FOREST SANDALWOOD         SANTALUM FREYCINETIANUM
C   41 = SAPA7    MOUNTAIN SANDALWOOD       SANTALUM PANICULATUM
C   42 = SAHA2    HALEAKALA SANDALWOOD      SANTALUM HALEAKALAE
C   43 = SAELC    KAUAI SANDALWOOD          SANTALUM ELLIPTICUM
C   44 =          nothing
C   45 =          OTHER
C----------
C
...
C
     ...
     &   73.3348,  149.5861, 6*1709.7229, 1709.7229, 1709.7229/
C
      DATA (OLYMPC(I,2),I=1,45)/
     ...
     &    2.6548,    2.4231, 6*5.8887, 5.8887, 5.8887/
C
      DATA (OLYMPC(I,3),I=1,45)/
