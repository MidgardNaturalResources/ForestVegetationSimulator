...
C.... model.
C....
C.... The following IRTSPC is used with variant HI :
C.... HI has 45 species.
C RD     
...
C  40  NH  38 = KOA (AK)                        ACACIA KOA
C  40  NH  39 = OHIA (LE)                       METROSIDEROS POLYMORPHA
C  40  NH  40 = FOREST SANDALWOOD (IF)         SANTALUM FREYCINETIANUM
C  40  NH  41 = MOUNTAIN SANDALWOOD (IM)       SANTALUM PANICULATUM
C  40  NH  42 = HALEAKALA SANDALWOOD (IH)      SANTALUM HALEAKALAE
C  40  NH  43 = KAUAI SANDALWOOD (IK)          SANTALUM PYRULARIUM
C  40  NH  44 = ---
C  40  NH  45 = OTHER (OT)
