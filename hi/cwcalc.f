...
C         ADtoCW       RA       PB   ABtoPB   BAtoCW       AS       CW
...
C
      ...
      END SELECT
C----------
C      IF(DEBUG)WRITE(JSTND2,*)
C     &' ENTERING CWCALC: ISPC,CWEQN,VARACD= ',ISPC,CWEQN,VARACD
C      IF(DEBUG)WRITE(JSTND2,*)' ISPC,P,D,H,CR,IICR,CW,IWHO,JSTND2= ',
C     &ISPC,P,D,H,CR,IICR,CW,IWHO,JSTND2
C      IF(DEBUG)WRITE(JSTND2,*)' ISPC,IFOR,KODFOR= ',ISPC,IFOR,KODFOR
C----------
