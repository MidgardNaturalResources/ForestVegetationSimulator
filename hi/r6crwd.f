...
C----------
      ...
      INTEGER ISPC,INDX
      INTEGER MAPSO(33),MAPEC(32),MAPNC(12),MAPWC(45),
...
C 31=WB, 32=KP, 33=PY, 34=DG, 35=HW, 36=BC, 37=WI, 38=AK, 39=LE, 40=IF,
C 41=IM, 42=IH, 43=IK, 44=__, 45=OT
C
C SURROGATES: DF FOR RW, RA FOR WA, WO FOR GC, BM FOR CO, PY FOR J,
C             WO FOR DG, PY FOR HW, PY FOR BC, PY FOR WI, DF FOR AK,
C             DF FOR LE, DF FOR IF, DF FOR IM, DF FOR IH, DF FOR IK, DF FOR OT
C
      DATA MAPWC/
     &  2,  3,  4,  5,  6, 25,  7, 10,  8, 24,
     & 19, 20, 21, 22, 23,  1,  1, 11, 14, 15,
     & 26, 27, 27, 28, 30, 29, 26, 30, 16, 12,
     & 17, 18, 16, 30, 16, 16, 16,  6*1, 16,  1/
C----------
...
C 41=WA 42=TO 43=SY 44=AS 45=CO 46=WI 47=CN 48=BL 49=OH 50=RW
C----------
      DATA MAPCA /
...
C
     ...
     & 9*99, 27, 26, 2*99/
C----------
C  MAPPING FUNCTION FOR THE OC VARIANT
C
C  1=PC  2=IC  3=RC  4=GF  5=RF  6=SF  7=DF  8=WH  9=MH 10=WB
C 11=KP 12=LP 13=CP 14=LM 15=JP 16=SP 17=WP 18=PP 19=MP 20=GP
C 21=JU 22=BS 23=GS 24=PY 25=OS 26=LO 27=CY 28=DO 29=EO 30=WO
C 31=BO 32=VO 33=IO 34=BM 35=BU 36=RA 37=MA 38=GC 39=DG 40=OA
C 41=WA 42=TO 43=SY 44=AS 45=CO 46=WI 47=CN 48=BL 49=OH 50=RW
C----------
     ...
     & 26, 29, 29, 29, 26, 16, 29, 26, 30,  1/
C----------
C MAPPING FUNCTION FOR SPECIES IN THE OP VARIANT
C  1=SF,  2=WF,  3=GF,  4=AF,  5=RF,  6=SS,  7=NF,  8=YC,  9=IC, 10=ES,
C 11=LP, 12=JP, 13=SP, 14=WP, 15=PP, 16=DF, 17=RW, 18=RC, 19=WH, 20=MH,
C 21=BM, 22=RA, 23=MA, 24=TO, 25=GC, 26=AS, 27=CW, 28=WO, 29=J , 30=LL,
C 31=WB, 32=KP, 33=PY, 34=DG, 35=HW, 36=BC, 37=WI, 38=AK, 39=LE, 40=IF,
C 41=IM, 42=IH, 43=IK, 44=__, 45=OT
C
C SURROGATES: DF FOR RW, AS FOR MA AND TO,     WO FOR GC, BM FOR CO, PY FOR J,
C             WO FOR DG, PY FOR HW, PY FOR BC, PY FOR WI, DF FOR AK,
C             DF FOR LE, DF FOR IF, DF FOR IM, DF FOR IH, DF FOR IK, DF FOR OT
C
      DATA MAPOP/
